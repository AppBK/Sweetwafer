...
| PUT /api/cart/delete/<int:id>        | This fetch is sent to delete an item from the cart. Upon success, it returns the string "Success", otherwise, wwe throw an error.                | "Success"<br>Status: 200<br>|
